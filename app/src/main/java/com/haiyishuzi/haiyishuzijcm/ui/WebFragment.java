...
import com.haiyishuzi.cordovayzd.CordovaFragment;
...
public class WebFragment extends CordovaFragment implements Injectable, UserFragmentLabel {

    private static final String LAUNCH_URL = "LAUNCH_URL";
    //是否要注入本地js
    private static final String NATIVE_JS = "NATIVE_JS";

    public static WebFragment create(String url,boolean nativeJs) {
