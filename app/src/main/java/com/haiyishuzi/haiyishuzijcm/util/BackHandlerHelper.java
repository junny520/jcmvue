...
import com.haiyishuzi.haiyishuzijcm.ui.FragmentBackHandler;
...
public class BackHandlerHelper {
     ...
     *
     * 如果NavigationController中跳转不加addToBackStack(null)也可以fragment继承FragmentBackHandler实现onBackPressed来完成fragment处理返回键，
     * 告诉activity已经处理back
     *
     * @return 如果处理了back键则返回 <b>true</b>
     */
