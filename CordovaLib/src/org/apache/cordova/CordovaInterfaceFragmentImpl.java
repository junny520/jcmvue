...
/**
 * wpl添加CordovaInterface的fragment实现
 * Default implementation of CordovaInterface.
 */
public class CordovaInterfaceFragmentImpl implements CordovaInterface {
    ...
    public CordovaInterfaceFragmentImpl(Fragment fragment) {
        this(fragment, Executors.newCachedThreadPool());
    }

    public CordovaInterfaceFragmentImpl(@NonNull Fragment fragment, ExecutorService threadPool) {
