 ...
 */
public class InjectionWebViewEngine implements CordovaWebViewEngine {
    public static final String TAG = "SystemWebViewEngine";

    protected final InjectionWebView webView;
    protected final InjectionCookieManager cookieManager;
    ...
    public InjectionWebViewEngine(Context context, CordovaPreferences preferences) {
        this(new InjectionWebView(context), preferences);
    }

    public InjectionWebViewEngine(InjectionWebView webView) {
        this(webView, null);
    }

    public InjectionWebViewEngine(InjectionWebView webView, CordovaPreferences preferences) {
        this.preferences = preferences;
        this.webView = webView;
        cookieManager = new InjectionCookieManager(webView);
    }
    ...
    public void init(CordovaWebView parentWebView, CordovaInterface cordova, Client client,
        ...
        nativeToJsMessageQueue.addBridgeMode(new NativeToJsMessageQueue.OnlineEventsBridgeMode(new NativeToJsMessageQueue.OnlineEventsBridgeMode.OnlineEventsBridgeModeDelegate() {
            ...
            public void runOnUiThread(Runnable r) {
                InjectionWebViewEngine.this.cordova.getActivity().runOnUiThread(r);
            }
        }));
