 ...
 * CordovaChromeClient.
 */
public class InjectionWebViewClient extends WebViewClient {

    private static final String LOG_TAG = "InjectionWebViewClient";
    private static final String NATIVE_JS_PREFIX = "https://native-js/";
    private static final String TAG = "InjectionWebViewClient";
    protected final InjectionWebViewEngine parentEngine;
    ...
    public InjectionWebViewClient(InjectionWebViewEngine parentEngine) {
    ...
    private void injectDeferredObject(String source, String jsWrapper) {
        if (parentEngine.webView != null) {
            ...
            parentEngine.cordova.getActivity().runOnUiThread(new Runnable() {
                @SuppressLint("NewApi")
                @Override
                public void run() {
                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
                        // This action will have the side-effect of blurring the currently focused element
                        parentEngine.webView.loadUrl("javascript:" + finalScriptToInject);
                    } else {
                        parentEngine.webView.evaluateJavascript(finalScriptToInject, null);
                    }
                }
            });
        } else {
...
//            return null;
    ...
    private WebResourceResponse processInterceptRequest(WebView view, String url) {
